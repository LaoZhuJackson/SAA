...
status = {'maxhp': 2, 'shp': 2, 'ehp': 2, 'live': 1, 'blank': 2, 'fired': [], 'sitems': ['reset_hammer', 'reset_hammer'], 'eitems': ['insight_sunglasses'], 'power': 1, 'bullet': -1, 'reversal': False, 'extra_opp': False, 'computer': False}
