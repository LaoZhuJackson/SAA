    ...
    def check_power(self):
        ...
        while True:
            ...
            if enter_power_select:
                ...
                if has_colon:
                    if self.auto.click_element([':','：'],'text',crop=(282/1920,294/1080,800/1920,342/1080)):
                        confirm_flag = True
                        continue
                    confirm_flag = False
                # 存在大于一天但是小于day_num的体力药,并且进入了选择体力界面
                if current_check<=self.day_num:
                    if self.auto.click_element(f"{current_check}天", "text",crop=(282/1920, 294/1080, 799/1920, 342/1080)):
                        confirm_flag = True
                        continue
    ...
    def by_maneuver(self):
        ...
        while True:
            ...
            if not enter_maneuver_flag:
                ...
                if finish_flag:
                    if self.auto.find_element('剩余', 'text',crop=(0,0,0.5,0.5)) or self.auto.find_element('领取', 'text', crop=(0, 937 / 1080, 266 / 1920, 1)):
                        enter_task = True
                    if enter_task:
                    ...
                    if self.auto.click_element('最大', 'text', crop=(1221 / 1920, 679 / 1080, 1354 / 1920, 756 / 1080)):
                        pass
                    if self.auto.click_element('开始作战', 'text', crop=(868 / 1920, 808 / 1080, 1046 / 1920, 865 / 1080)):
                        time.sleep(0.5)
                        continue
