...
class CollectSuppliesModule(BaseTask):
    ...
    def friends_power(self):
        ...
        while True:
            ...
            if self.auto.find_element('感知','text',crop=(761/1920,517/1080,1175/1920,563/1080)):
                break
            # 重复进入的情况
            if self.auto.find_element('app/resource/images/reward/home.png','image',threshold=0.9,crop=(1635/1920,18/1080,1701/1920,74/1080)):
                if not self.auto.find_element('键收赠', 'text', crop=(1722/1920, 1012/1080, 1858/1920, 1055/1080)):
                    break
            if self.auto.click_element('键收赠', 'text', crop=(1722/1920, 1012/1080, 1858/1920, 1055/1080)):
                continue
            if self.auto.click_element("app/resource/images/collect_supplies/friends.png", "image",crop=(259/1920,448/1080,364/1920,515/1080)):
                continue
    ...
    def station_power(self):
        ...
        while True:
            ...
            # 已经领取但重复进入的情况
            if self.auto.find_element('app/resource/images/reward/home.png','image',threshold=0.9,crop=(1635/1920,18/1080,1701/1920,74/1080)):
                if self.auto.find_element('app/resource/images/collect_supplies/supply_station_selected.png','image',threshold=0.9,crop=(0,397/1080,91/1920,486/1080)):
                    if not self.auto.find_element("每日物资配给箱", "text", crop=(223 / 1920, 625 / 1080, 500 / 1920, 677 / 1080)):
                        break
            if self.auto.click_element("app/resource/images/collect_supplies/supply_station.png", "image",threshold=0.9,crop=(0,397/1080,91/1920,486/1080)):
                pass
    ...
    def receive_mail(self):
        ...
        while True:
            ...
            if self.auto.click_element('批量领取','text',crop=(303/1920,982/1080,462/1920,1028/1080)):
                continue
            if self.auto.click_element('app/resource/images/collect_supplies/mail.png','image',crop=(76/1920,437/1080,151/1920,491/1080)):
                continue
