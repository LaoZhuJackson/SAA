        ...
        while True:
            ...
            if finish_flag:
                if self.auto.click_element('完成', 'text', crop=(880 / 1920, 968 / 1080, 1033 / 1920, 1024 / 1080)):
                    time.sleep(0.5)
                    if not self.auto.find_element('完成', 'text', crop=(880 / 1920, 968 / 1080, 1033 / 1920, 1024 / 1080),take_screenshot=True):
                        break
                else:
                    self.update_power_times()
                    if self.auto.find_element("故事", "text",crop=(0,0,212/1920,61/1080)) and (self.power_times==0 or self.power_times==6):
                        break
                continue
        ...
        while True:
            ...
            if confirm_flag:
                ...
                if current_num == 2 or current_num == 1:
                    ...
                    return True
            if self.auto.click_element("app/resource/images/person/add_power.png", "image",crop=(1533/1920,23/1080,1599/1920,81/1080)):
                time.sleep(0.5)
                continue
            if timeout.reached():
